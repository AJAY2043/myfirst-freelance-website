        ...
        <div className="navbar">
          ...
          <div className={`nav-menu ${isMenuOpen ? 'active' : ''}`}>
            ...
            <div className="nav-item">
              ...
              {isServicesOpen && (
                <div className="dropdown">
                  <Link to="/runflatsystems" style={{color:'blue'}}>Runflat Tires Systems</Link>
                  <Link to="/militaryrunflatsystem" style={{color:'blue'}}>Military Runflat Tires Systems</Link>
                  <Link to="/beadlocksystem" style={{color:'orange'}}>Beadlock Systems</Link>
                  <Link to="/heavydutywheels" style={{color:'green'}}>Heavy-duty Wheels</Link>
                  <Link to="/militarywheels" style={{color:'green'}}>Military Wheels</Link>
                </div>
              )}
            </div>
